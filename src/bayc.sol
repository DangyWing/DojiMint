 ...
 */
contract DCrew is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant apePrice = 44000000000000000; //0.044 ETH

    uint256 public constant maxApePurchase = 50;

    uint256 public MAX_APES = 999;

    bool public saleIsActive = true;

    uint256 public REVEAL_TIMESTAMP = 1;
     ...
     * Claims D
     */
    function claimD(uint256 numberOfTokens) public payable {
        require(
